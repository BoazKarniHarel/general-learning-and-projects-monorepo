...
def init_llm():
    ...
    logger.debug("Embeddings initialized with model device: %s", DEVICE)  # create object of Hugging Face Instruct Embeddings with (model_name,  model_kwargs={"device": DEVICE} )
    # ) This close parenthesis was here for some reason
