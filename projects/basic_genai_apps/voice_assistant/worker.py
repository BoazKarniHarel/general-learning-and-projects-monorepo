...
def speech_to_text(audio_binary):
    ...
    body = audio_binary  # TODO  understand what is the purpose of this line considering audio_binary is in the request
    ...
    return text  #TODO understand why this is in the while loop
